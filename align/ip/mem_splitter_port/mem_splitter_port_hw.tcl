...
set_module_property NAME mem_splitter_port
...
set_module_property DISPLAY_NAME "ACL Bank Splitter w. Reorder Multi Port"
set_module_property TOP_LEVEL_HDL_FILE mem_splitter_port.sv
set_module_property TOP_LEVEL_HDL_MODULE mem_splitter_port
...
# | files
# | 
add_file mem_splitter_port.sv {SYNTHESIS SIMULATION}
...
add_parameter MULTI_PORT_MODE BOOLEAN false
set_parameter_property MULTI_PORT_MODE DEFAULT_VALUE false
set_parameter_property MULTI_PORT_MODE DISPLAY_NAME "Use the banks as multiple ports with shared address"
set_parameter_property MULTI_PORT_MODE AFFECTS_ELABORATION true
set_parameter_property MULTI_PORT_MODE HDL_PARAMETER true
...
proc validate {} {
    ...
    set multi_port [ get_parameter_value MULTI_PORT_MODE ]
