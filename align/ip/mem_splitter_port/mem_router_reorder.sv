...
module mem_router_reorder #(    
    ...
    parameter integer MULTI_PORT_MODE = 0
)
(
    input logic clock,
    input logic resetn,
    ...
    output logic [(MULTI_PORT_MODE ? ADDRESS_W-2 : ADDRESS_W-$clog2(NUM_BANKS)-1):0] b_arb_address [NUM_BANKS],
    ...
    logic [(MULTI_PORT_MODE ? ADDRESS_W-2 : ADDRESS_W-$clog2(NUM_BANKS)-1):0] m_arb_bank_address;
